...
b2Body* DestructionBlockPowerup::createWallPhysics(float x, float y, float xEnd, float yEnd, b2World* m_world)
{
	/*
...
CCSprite* DestructionBlockPowerup::createWallSprite(float x, float y)
{
...
void DestructionBlockPowerup::effect(WorldObject* test)
{
	test->setState(2, 5);
}